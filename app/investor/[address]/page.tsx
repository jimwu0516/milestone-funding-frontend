// app/investor/[address]/page.tsx
"use client";

import { useParams, useRouter } from "next/navigation";
import { formatEther } from "viem";
import Navbar from "@/components/Navbar";
import { useProjectsByInvestor } from "@/hooks/useContract";
...
export default function InvestorProjectsPage() {
  ...
  const { investments: allProjects, isLoading } =
    useProjectsByInvestor(address);
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 pt-24 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold">Projects invested by</h1>
